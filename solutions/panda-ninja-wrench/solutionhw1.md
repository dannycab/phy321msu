...
:class: hint
$$
\exp{(i 2 \pi f t)} = \sum_{n=0}^{\infty}\frac{(i 2 \pi f t)^{n}}{(n)!}=1+ 2 \pi f t+\frac{(i 2 \pi f t)^{2}}{2!}+\frac{(i 2 \pi f t)^{3}}{3!}+\frac{(i 2 \pi f t)^{4}}{4!}+\frac{(i 2 \pi f t)^{5}}{5!}+\dots.
$$
:::
...
$$\exp{(i 2 \pi f t)} = \sum_{n=0}^{\infty}\frac{(i 2 \pi f t)^{n}}{(n)!}=1+i 2 \pi f t-\frac{(2 \pi f t)^{2}}{2!}-i\frac{(2 \pi f t)^{3}}{3!}+\frac{(2 \pi f t)^{4}}{4!}+i\frac{(2 \pi f t)^{5}}{5!}-\dots $$
$$\exp{(i 2 \pi f t)} = \left(1-\frac{(2 \pi f t)^{2}}{2!}+\frac{(2 \pi f t)^{4}}{4!}-\dots\right)+i\left(2 \pi f t-\frac{(2 \pi f t)^{3}}{3!}+\frac{(2 \pi f t)^{5}}{5!}-\dots\right)$$
