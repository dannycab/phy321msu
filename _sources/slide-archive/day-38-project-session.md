...
title: Day 38 - Project Work Session
description: Slides for PHY 321 Fall 2025, Day 38: Project Work Session
author: Prof. Danny Caballero <caball14@msu.edu>
keywords: classical mechanics, differential equations, motion, oscillations, resonance
url: https://dannycaballero.info/phy321msu/slides/day-38-project-session.html
---

# Day 38 - Project Work Session

![bg right width:600px](../images/notes/week13/plague.jpeg)
...
1. **Computational Essay – 60%** (Due Dec 8th)
2. **In-Class Presentation – 25%** (Next Week)
3. **Peer Review – 15%** (Next Week)
